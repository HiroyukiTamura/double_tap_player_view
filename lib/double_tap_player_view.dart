...
import 'package:double_tap_player_view/view_model/double_tap_view_model.dart';
import 'package:double_tap_player_view/custom_clipper/oval_left_border_clipper.dart';
import 'package:double_tap_player_view/custom_clipper/oval_right_border_clipper.dart';
...
class DoubleTapPlayerView extends StatelessWidget {
  ...
  void _onDoubleTapDown(BuildContext context, BoxConstraints constraints,
    ...
    context.read(_kPrvViewModel(vmConf).state).noteTapPosition(dx, dy);
  }
  ...
  void _onDoubleTap(BuildContext context, BoxConstraints constraints) {
    ...
    final ltr = lastTapTimeL < lastTapTimeR ? vmConfR : vmConfL;

    context.read(_kPrvViewModel(ltr)).notifyTap(constraints.maxWidth);
  }
}
